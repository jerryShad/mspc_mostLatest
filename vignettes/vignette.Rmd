...
```{r}
library(MSPC)
inputData <- readPeakFiles(peakFolder = "test/testData/", pvalueBase = 1L, verbose = FALSE)
...
total.ERs <- denoise_ERs(inputData, tau.w = 1.0E-04, .fileName = "noiseER", outDir = "", verbose = FALSE)
...
Then you can use the chunk option `fig.cap = "Your figure caption."` in **knitr**. `> special thanks to Martin Morgan solution on support site`
